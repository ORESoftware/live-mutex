...
[<assembly: AssemblyTitleAttribute("fsharp.Tests")>]
[<assembly: AssemblyProductAttribute("fsharp")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "fsharp.Tests"
    let [<Literal>] AssemblyProduct = "fsharp"
