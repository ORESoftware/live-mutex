...
flowchart TD
    ...
    GrantLock --> SendUnlockSuccess[Broker: Send unlocked=true<br/>to releasing client]
    SendUnlockSuccess --> SendSuccessNext[Broker: Send acquired=true<br/>to next client]
    SendSuccessNext --> ClientDone2[Client: Unlock complete]
