...
exports.runRWLockFileTest = runRWLockFileTest;
/**
 * Reader-Writer Lock File Test (TypeScript)
    ...
    return new Promise((resolve, reject) => {
        ...
        client.acquireReadLock(key, {}, (err, release) => {
            ...
            debug(`Reader ${readerId} read file`, {
                ...
                expectedValue,
                matches: expectedValue ? content === expectedValue : null
            });
    ...
    return new Promise((resolve, reject) => {
        ...
        client.acquireWriteLock(key, {}, (err, release) => {
            ...
            debug(`Writer ${writerId} read current value before write`, {
                ...
                currentValue,
                expectedBefore,
                matches: expectedBefore ? currentValue === expectedBefore : null
            });
...
async function runRWLockFileTest() {
    ...
    try {
        ...
        for (let i = 0; i < 20; i++) {
            ...
            const delayMs = i * 20; // Stagger starts
            setTimeout(() => {
                if (i % 2 === 0) {
                    // Writer
                    currentValue++;
        ...
        if (violations.length > 0) {
            ...
            throw new Error('Lock violations detected');
        }
        else {
